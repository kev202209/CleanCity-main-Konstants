...
try:
    ...
    driver.find_element(By.ID, "register-password").send_keys("t628/.;'ewe")
    ...
    # Check if login was successful by looking for a user-specific element or page
    # Adjust the check below as needed for your app (e.g., profile link, welcome message)
    if "Profile" in driver.page_source or "Dashboard" in driver.page_source:
        print("Login successful and user dashboard/profile visible.")
    else:
        print("Login may have failed or user dashboard/profile not found.")

    print("Register and login test completed successfully.")
